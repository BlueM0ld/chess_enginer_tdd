...
public class ChessBoard {
    private final Map<Piece, Tile> whiteOccupiedTiles = new HashMap<>();
    private final Map<Piece, Tile> blackOccupiedTiles = new HashMap<>();
...
//    public ChessBoard(char [] setup){}
    ...
    private Tile setPiece(char c, Position tilePosition) {
        ...
        if(side.equals(Side.WHITE)){whiteOccupiedTiles.put(piece,tile);}
        if(side.equals(Side.BLACK)){blackOccupiedTiles.put(piece,tile);}
        return tile;
    }

    public Map<Piece,Tile> getAllWhitePieces() {
        return this.whiteOccupiedTiles;
    }
    public Map<Piece,Tile> getAllBlackPieces() {
        return this.blackOccupiedTiles;
    }
